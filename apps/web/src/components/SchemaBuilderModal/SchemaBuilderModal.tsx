...
export type FormValues = Pick<
  ProCommonColumn,
  'title' | 'dataIndex' | 'valueType' | 'width' | 'hideInSearch' | 'formItemProps' | 'fieldProps'
>;
    ...
    <Drawer
      ...
      extra={
        <Space size="small">
          ...
          <Button onClick={handleSaveAndAddNext}>保存并继续添加</Button>
        </Space>
      }
    >
        ...
        >
          ...
          {showFormItemAndFieldProps ? (
            <>
              ...
              <Divider />
              <RuleBuilder name={formItemName} label={formItemLabel} valueType={valueTypeValue} />
            </>
          ) : null}
        </Form>
      </Space>
