...
interface TreeNodeItemProps {
  ...
  level: number;
  availableComponents: Array<{ type: ComponentType; label: string }>;
}

const TreeNodeItem: React.FC<TreeNodeItemProps> = ({ node, level, availableComponents }) => {
  ...
  const addNewNode = useBuilderStore(s => s.componentTree.addNewNode);
  const updateNode = useBuilderStore(s => s.componentTree.updateNode);
  const removeNode = useBuilderStore(s => s.componentTree.removeNode);
