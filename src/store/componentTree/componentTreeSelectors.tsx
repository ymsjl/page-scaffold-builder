...
import { componentTreeAdapter, type ComponentTreeState } from "./componentTreeSlice";
 ...
 */
export const getEditingColumn = (state: MaybeWritable<ComponentTreeState>) => state.editingColumn || null;
 ...
 */
export const getIsEntityModelModalOpen = (state: MaybeWritable<ComponentTreeState>) => state.isEntityModelModalOpen;
export const selectIsEntityModelModalOpen = createSelector(selectComponentTreeState, getIsEntityModelModalOpen);

/**
 * @description 获取正在编辑的实体模型ID
 */
export const getEditingEntityModelId = (state: MaybeWritable<ComponentTreeState>) => state.editingEntityModelId;
export const selectEditingEntityModelId = createSelector(selectComponentTreeState, getEditingEntityModelId);

/**
 * @description 获取组件树的 components 部分
 */
export const getComponents = (state: MaybeWritable<ComponentTreeState>) => state.components;
export const getComponentsEntities = (state: MaybeWritable<ComponentTreeState>) => getComponents(state).entities;

export const selectComponentTreeComponents = createSelector(selectComponentTreeState, getComponents);
export const componentNodesSelectors = componentTreeAdapter.getSelectors(selectComponentTreeComponents);
...
export const selectPreviewRootNodeId = createSelector(selectComponentTreeState, getPreviewRootNodeId);

/**
 * @description 获取选中节点的列配置
 */
export const getColumnsOfSelectedNodeResult = (node: ComponentNode | null | undefined): ProCommonColumn[] => node ? (node.props?.columns ?? []) : [];
export const selectColumnsOfSelectedNode = createSelector(selectSelectedNode, getColumnsOfSelectedNodeResult);

/**
 * @description 获取选中节点的类型
 * @returns ComponentType | null
 */
export const getTypeOfSelectedNodeResult = (node: ComponentNode | null | undefined): ComponentType | null => node ? node.type : null;
export const selectTypeOfSelectedNode = createSelector(selectSelectedNode, getTypeOfSelectedNodeResult);
...
export const selectNodeForPreview = createSelector(selectSelectedNode, getNodeForPreviewResult);
...
export const selectFirstParentPageNode = createSelector([selectSelectedNode, selectComponentTreeComponents], getFirstParentPageNodeResult);

/**
 * @description 获取选中节点关联的实体模型ID
 * @return string | null
 */
export const getSelectedNodeEntityModelIdResult = (node: ComponentNode | null | undefined): string | null => node?.props?.entityModelId || null;
export const selectSelectedNodeEntityModelId = createSelector(selectSelectedNode, getSelectedNodeEntityModelIdResult);
...
export const selectPreviewRootNode = createSelector([selectPreviewRootNodeId, selectComponentTreeComponents], getPreviewRootNodeResult);
...
export const selectEditingColumnProps = createSelector(selectEditingColumn, getEditingColumnPropsResult);
...
export const selectEntityModelInUse = createSelector([selectSelectedNodeEntityModelId, selectEntityModel], getEntityModelInUseResult);
...
export const selectRuleNodesOfEditingColumn = createSelector(selectEditingColumn, getRuleNodesOfEditingColumnResult);
...
export const selectEditingEntityModel = createSelector([selectEditingEntityModelId, selectEntityModel], getEditingEntityModelResult);
// ==================== Type Guards ====================
